namespace KlokanUI
{
	partial class DatabaseDetailForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.idLabel.Text = "Answer Sheet ID:";
			// 
			// yearLabel
			// 
			...
			this.scanLabel.Location = new System.Drawing.Point(321, 35);
			...
			this.answersLabel.Location = new System.Drawing.Point(687, 36);
			...
			this.reevaluateButton.Text = "Re-Evaluate Entry";
			this.reevaluateButton.UseVisualStyleBackColor = true;
			this.reevaluateButton.Click += new System.EventHandler(this.reevaluateButton_Click);
			// 
