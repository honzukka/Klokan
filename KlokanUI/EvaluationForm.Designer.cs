namespace KlokanUI
{
	partial class EvaluationForm
	{
		...
		private void InitializeComponent()
		{
			...
			// benjaminCheckBox
			// 
			resources.ApplyResources(this.benjaminCheckBox, "benjaminCheckBox");
			...
			// benjaminEditButton
			// 
			resources.ApplyResources(this.benjaminEditButton, "benjaminEditButton");
			...
			// kadetEditButton
			// 
			resources.ApplyResources(this.kadetEditButton, "kadetEditButton");
			...
			// kadetCheckBox
			// 
			resources.ApplyResources(this.kadetCheckBox, "kadetCheckBox");
			...
			// juniorEditButton
			// 
			resources.ApplyResources(this.juniorEditButton, "juniorEditButton");
			...
			// juniorCheckBox
			// 
			resources.ApplyResources(this.juniorCheckBox, "juniorCheckBox");
			...
			// studentEditButton
			// 
			resources.ApplyResources(this.studentEditButton, "studentEditButton");
			...
			// studentCheckBox
			// 
			resources.ApplyResources(this.studentCheckBox, "studentCheckBox");
			...
			// 
			resources.ApplyResources(this.defaultParamsRadioButton, "defaultParamsRadioButton");
			...
			// 
			resources.ApplyResources(this.customParamsRadioButton, "customParamsRadioButton");
